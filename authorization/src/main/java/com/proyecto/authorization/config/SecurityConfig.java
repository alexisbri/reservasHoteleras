package com.proyecto.authorization.config;
...
import com.proyecto.authorization.services.CustomUserDetails;
...
public class SecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http)
        ...
        http
                ...
                // <-- se quita el bloque .cors(...) de aquí: ahora se maneja centralizado en el Gateway
